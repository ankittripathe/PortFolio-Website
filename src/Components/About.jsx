          ...
          <div class="about-content">
            ...
            <div class="text-side">
              ...
              <p>
                ...
                HTML, CSS, JavaScript, React, Tailwind CSS, SCSS and Framer
                Motion. I specialize in building responsive, high-performance
                websites that deliver seamless user experiences. With a focus on
                clean, optimized code and modern development tools, I create
                dynamic and visually engaging interfaces. I am also a team
